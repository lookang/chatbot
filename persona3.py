# https://persona3personwithcervicalcancer.streamlit.app/
...
def ch10():
    ...
    st.title("person who suffered from cervical cancer")
...
say you do not know. Do not make up information."
    ...
    try:
        ...
        if prompt := st.chat_input("Ask cervical cancer related question"):
